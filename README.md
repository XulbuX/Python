...
These are **harmless** prank scripts (*also as <a href="./prankware/exe" title="open prankware/exe directory">executables</a>*), that do all sorts of annoying things.<br>
Every script/executable has an exact description of what it does in this directory's [**`README.md`**](./prankware/README.md).
