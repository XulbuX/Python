...
After you [download](https://github.com/XulbuX/Python/raw/refs/heads/main/Projects/x-convert/x-convert.exe) the file (*Python or EXE, it doesn't matter*), you can first run it normally.<br>
